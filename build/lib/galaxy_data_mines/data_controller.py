...
class DataController:
    ...
    # New labels (removed any that stayed the same)
        ...
        'Cl*?': 'Cl?', # Some objects still have old object type
        'GlCl_Candidate': 'Gl?',
        'Cluster*': 'Cl*',
        'Cl*': 'Cl*', # Some objects still have old object type
        'GlobCluster': 'GlC',
        ...
        '**': '**',
        'EclBin': 'EB*',
        'EB*Algol': 'Al*', # Left in for now - not sure if still part of classification scheme
        'EB*betLyr': 'bL*', # Left in for now - not sure if still part of classification scheme
        'EB*WUMa': 'WU*', # Left in for now - not sure if still part of classification scheme
        'SB*': 'SB*',
        'EllipVar': 'El*',
        'Symbiotic*': 'Sy*',
        'CataclyV*': 'CV*',
        'DQHer': 'DQ*', # Left in for now - not sure if still part of classification scheme
        'AMHer': 'AM*', # Left in for now - not sure if still part of classification scheme
        'Nova-like': 'NL*', # Left in for now - not sure if still part of classification scheme
        'Nova': 'No*',
        'DwarfNova': 'DN*', # Left in for now - not sure if still part of classification scheme
        'XrayBin': 'XB*',
        'LowMassXBin': 'LXB',
        'HightMassXBin': 'HXB',
        'ISM': 'ISM',
        ...
        'HVCld': 'HVC',
        'HIIReg': 'HII',
        'HII': 'HII', # Some objects still have old object type
        'PlanetaryNeb': 'PN',
        'HIshell': 'sh',
        'SNR_Candidate': 'SR?',
        'SNR?': 'SR?', # Some objects still have old object type
        'SNRemnant_Candidate': 'SR?', # Some objects also classified like this
        'SNRemnant': 'SNR',
        'SNR': 'SNR', # Some objects still have old object type
        ...
        'Mira': 'Mi*',
        'Supernova': 'SN*',
        'Sub-stellar': 'su*', # No longer exists?
        'Planet_Candidate': 'Pl?',
        'Planet': 'Pl',
        'Galaxy': 'G',
        'PartofG': 'PoG',
